<template>
    <v-container class="pa-0 pb-5" >
        <v-layout wrap align-center justify-center row fill-height>
            <v-flex xs12 md12>
                <p class="google-font mt-2 mb-0" style="font-size:170%;color:#0277BD;" >Partners</p>
                ...
                <p class="google-font mt-0" style="font-size:120%">If you’re interested in being showcased throughout <b>{{chapterDetails.ChapterName}}</b>, contact us at <a style="color:#1565C0;text-decoration: none;" :href="`mailto:${chapterDetails.ChapterEmail}`">{{chapterDetails.ChapterEmail}}</a> to discuss sponsorship opportunities.</p>
            </v-flex>
                        ...
                        <v-card class="elevation-0 pa-0 ma-0 transparent">
                            <v-container grid-list-sm fluid class="pa-0 ma-0" >
                                <v-layout row wrap class="ma-0 pa-0">
                                    ...
                                    >
                                    <!-- style="border-radius:5px;border-color:#e0e0e0;border-width: 0px; border-style: solid;" -->
                                    <v-card flat tile class="d-flex elevation-1" style="border-radius:0px;border-width: 0px; border-style: solid;">
                            ...
                            <v-container grid-list-sm fluid class="pa-0 ma-0">
                                <v-layout row wrap class="ma-0 pa-0">
                                    <v-flex
                                        ...
                                        class="elevation-0"
                                    >
                                    <v-card flat tile class="d-flex pa-2 ma-1 elevation-1" style="border-radius:0px;border-width: 1px; border-style: solid;">
