    ...
    <v-layout wrap align-center justify-center row fill-height>
      <v-flex xs12 md3 lg3 class="pa-2">
        ...
        <p class="google-font" style="font-size:110%">
          Dev Cluster is a tech community for engineers and developers to learn
          and grow together.
        </p>
      ...
      <v-flex xs12 md9 lg9 class="">
        <v-layout row wrap>
          <v-flex xs6 sm6 md3 lg3 class="text-xs-center pa-2">
            <v-icon color="white" large style="font-size:300%"
              >chat_bubble</v-icon
            >
            ...
            <p class="google-font" style="font-size:110%">
              Learn about the latest developments in the world of technology
            </p>
          </v-flex>
          ...
          <v-flex xs6 sm6 md3 lg3 class="text-xs-center pa-2">
            ...
            <p class="google-font" style="font-size:110%">
              With our campus connect, the latest from us reaches you in your
              classroom
            </p>
          </v-flex>
          ...
          <v-flex xs6 sm6 md3 lg3 class="text-xs-center pa-2">
            ...
            <p class="google-font" style="font-size:110%">
              Watch the latest from tech giants and discuss what this means for
              us
            </p>
          </v-flex>
        </v-layout>
