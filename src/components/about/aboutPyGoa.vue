    ...
    <v-container class="pa-0 my-0">
        <v-layout wrap align-start justify-start row fill-height class="my-0" >
           <v-flex xs12 sm5 md4 lg4 class="pa-2">
                <v-img
                    :src="require('@/assets/img/dev-connect.jpg')" 
                    :lazy-src="require('@/assets/img/dev-connect.jpg')"
                    class=""
                    width="100%"><!--Originally gdg.png used-->
                    <v-layout
                        slot="placeholder"
                        fill-height
                        align-center
            ...
            <v-flex xs12 sm7 md8 lg8 class="pa-2 my-0">
                ...
                <p class="google-font" style="font-size:120%;">{{chapterDetails.ChapterHistory}}</p>
                
                <!--<p class="google-font grey--text mt-3" style="font-size:120%">{{chapterDetails.aboutGDGProgram}}</p>-->

                <v-btn href="http://bit.ly/JoinDevCluster" target="_blank" class="ma-0 google-font elevation-1" color="#1a73e8" style="text-transform: capitalize;border-radius:5px;color:white">Become a Team Member</v-btn>
                &nbsp;
...
<script>
import ChapterDetails from '@/assets/data/pyGoa.json'
export default {
    data() {
        return {
