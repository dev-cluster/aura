<template>
    <v-container class="pa-0 pb-5" >
        <v-layout wrap align-center justify-center row fill-height>
            <v-flex xs12 md12>
                <p class="google-font mt-2 mb-0" style="font-size:170%;color:#0277BD;" >Template Partner</p>
                <p class="google-font mt-1 mb-0" style="font-size:120%">A very big thank you to GDG Jalandhar!</p>
            </v-flex>            
